...
def layout():
    ...
    for col in cols_dias:
        estilos_condicionales.extend([
            {'if': {'column_id': col, 'filter_query': f'{{{col}}} contains "AUS"'}, 'backgroundColor': "#CFB8B8", 'color': "#38385C", 'fontSize': '10px'},
            {'if': {'column_id': col, 'filter_query': f'{{{col}}} contains "BAJA"'}, 'backgroundColor': '#AEA4BF', 'color': '#FFFFFF', 'fontSize': '10px'},
            {'if': {'column_id': col, 'filter_query': f'{{{col}}} contains "VAC"'}, 'backgroundColor': "#64C723CF", 'color': '#474751', 'fontSize': '10px'},
    ...
    return html.Div([
        ...
        html.H3("Matriz de Estimación Temporal (ET)", className="serveo-titulo-pagina"),
        ...
        html.Div([
            ...
            # Leyenda
            html.Div([
                html.Span("LEYENDA: ", className="etiqueta-dato", style={'marginRight': '12px', 'marginBottom': '0'}),
                html.Span("Nivel 1 (Crítico)", style={'backgroundColor': 'var(--semantic-negative)', 'color': '#FFFFFF', 'padding': '4px 8px', 'borderRadius': '4px', 'marginRight': '8px'}),
                html.Span("Nivel 2 (Medio)", style={'backgroundColor': 'var(--accent)', 'color': '#FFFFFF', 'padding': '4px 8px', 'borderRadius': '4px', 'marginRight': '8px'}),
                html.Span("Nivel 3 (Estándar)", style={'backgroundColor': 'var(--semantic-positive)', 'color': '#FFFFFF', 'padding': '4px 8px', 'borderRadius': '4px', 'marginRight': '8px'}),
                html.Span("Vacaciones", style={'backgroundColor': 'var(--secondary)', 'color': 'var(--text-border)', 'padding': '4px 8px', 'borderRadius': '4px', 'marginRight': '8px'}),
